...
// WM_SYSCOMMAND Windows Messages
const (
	WM_SYSCOMMAND = 0x0112
)

const (
	// SC_SIZE System Menu Command Values
	SC_SIZE         = 61440
	SC_MOVE         = 61456
	SC_MINIMIZE     = 61472
	SC_MAXIMIZE     = 61488
...
const (
	// SB_HORZ Scroll Bar Constants
	SB_HORZ = 0
	SB_VERT = 1
	SB_CTL  = 2
	SB_BOTH = 3

	// SB_LINEUP Scroll Bar Commands
	SB_LINEUP        = 0
	SB_LINELEFT      = 0
	SB_LINEDOWN      = 1
	SB_LINERIGHT     = 1
	...
	// HIDE_WINDOW Old ShowWindow() Commands
	HIDE_WINDOW         = 0
	SHOW_OPENWINDOW     = 1
	SHOW_ICONWINDOW     = 2
	SHOW_FULLSCREEN     = 3
	...
	// SW_PARENTCLOSING Identifiers for the WM_SHOWWINDOW message
	SW_PARENTCLOSING = 1
	SW_OTHERZOOM     = 2
	SW_PARENTOPENING = 3
	SW_OTHERUNZOOM   = 4
...
const (
	// CP_ACP Code Page Default Values.
...
const (
	...
	// WS_EX_DLGMODALFRAME Extended Window Styles
...
const (
	...
	// PROCESS_ALL_ACCESS if NTDDI_VERSION >= NTDDI_VISTA
...
const (
	...
	// TOKEN_ALL_ACCESS if _WIN32_WINNT > 0x0400 || !defined(_WIN32_WINNT)
...
const (
	// BI_RGB constants for the biCompression field
	BI_RGB       = 0
	BI_RLE8      = 1
	BI_RLE4      = 2
	BI_BITFIELDS = 3

	// AC_SRC_OVER currently defined blend function
	AC_SRC_OVER  = 0x00
	AC_SRC_ALPHA = 0x01

	// AC_SRC_NO_PREMULT_ALPHA alpha format flags
...
const (
	// SHCNRF_InterruptLevel File System Notification flags
	...
	// SHCNF_IDLIST Flags, uFlags & SHCNF_TYPE is an ID which indicates what dwItem1 and dwItem2 mean
...
const (
	...
	// SRCCOPY /* Ternary raster operations */
...
const (
	// COINIT_MULTITHREADED flags passed as the coInit parameter to CoInitializeEx.
...
const (
	// RT_CURSOR /* Predefined Resource Types */
	RT_CURSOR       = 1
	RT_BITMAP       = 2
	RT_ICON         = 3
	RT_MENU         = 4
...
const (
	// SE_ERR_FNF /* regular WinExec() codes */
	...
	// SE_ERR_SHARE /* error values for ShellExecute() beyond the regular WinExec() codes */
	SE_ERR_SHARE           = 26
	...
	// SEE_MASK_DEFAULT /* Note CLASSKEY overrides CLASSNAME */
	SEE_MASK_DEFAULT   = 0x00000000
	SEE_MASK_CLASSNAME = 0x00000001
	SEE_MASK_CLASSKEY  = 0x00000003
	// SEE_MASK_IDLIST /* Note INDIVIDUALIST overrides IDLIST */
