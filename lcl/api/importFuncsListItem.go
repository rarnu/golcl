...
func ListItem_Free(obj uintptr) {
	_, _, _ = getLazyProc("ListItem_Free").Call(obj)
}

func ListItem_DisplayRectSubItem(obj uintptr, subItem int32, Code TDisplayCode) TRect {
	var ret TRect
	_, _, _ = getLazyProc("ListItem_DisplayRectSubItem").Call(obj, uintptr(subItem), uintptr(Code), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ListItem_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("ListItem_Assign").Call(obj, Source)
}

func ListItem_Delete(obj uintptr) {
	_, _, _ = getLazyProc("ListItem_Delete").Call(obj)
}

func ListItem_DisplayRect(obj uintptr, Code TDisplayCode) TRect {
	var ret TRect
	_, _, _ = getLazyProc("ListItem_DisplayRect").Call(obj, uintptr(Code), uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func ListItem_MakeVisible(obj uintptr, PartialOK bool) {
	_, _, _ = getLazyProc("ListItem_MakeVisible").Call(obj, GoBoolToDBool(PartialOK))
}
...
func ListItem_SetDropTarget(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ListItem_SetDropTarget").Call(obj, GoBoolToDBool(value))
}
...
func ListItem_SetCaption(obj uintptr, value string) {
	_, _, _ = getLazyProc("ListItem_SetCaption").Call(obj, GoStrToDStr(value))
}
...
func ListItem_SetChecked(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ListItem_SetChecked").Call(obj, GoBoolToDBool(value))
}
...
func ListItem_SetCut(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ListItem_SetCut").Call(obj, GoBoolToDBool(value))
}
...
func ListItem_SetData(obj uintptr, value unsafe.Pointer) {
	_, _, _ = getLazyProc("ListItem_SetData").Call(obj, uintptr(value))
}
...
func ListItem_SetFocused(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ListItem_SetFocused").Call(obj, GoBoolToDBool(value))
}
...
func ListItem_SetImageIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ListItem_SetImageIndex").Call(obj, uintptr(value))
}
...
func ListItem_SetLeft(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ListItem_SetLeft").Call(obj, uintptr(value))
}
...
func ListItem_GetPosition(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ListItem_GetPosition").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ListItem_SetPosition(obj uintptr, value TPoint) {
	_, _, _ = getLazyProc("ListItem_SetPosition").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func ListItem_SetSelected(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ListItem_SetSelected").Call(obj, GoBoolToDBool(value))
}
...
func ListItem_SetStateIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ListItem_SetStateIndex").Call(obj, uintptr(value))
}
...
func ListItem_SetSubItems(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ListItem_SetSubItems").Call(obj, value)
}
...
func ListItem_SetTop(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ListItem_SetTop").Call(obj, uintptr(value))
}
...
func ListItem_SetSubItemImages(obj uintptr, Index int32, value int32) {
	_, _, _ = getLazyProc("ListItem_SetSubItemImages").Call(obj, uintptr(Index), uintptr(value))
}
