...
func DragDockObject_Free(obj uintptr) {
	_, _, _ = getLazyProc("DragDockObject_Free").Call(obj)
}

func DragDockObject_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("DragDockObject_Assign").Call(obj, Source)
}

func DragDockObject_HideDragImage(obj uintptr) {
	_, _, _ = getLazyProc("DragDockObject_HideDragImage").Call(obj)
}

func DragDockObject_ShowDragImage(obj uintptr) {
	_, _, _ = getLazyProc("DragDockObject_ShowDragImage").Call(obj)
}
...
func DragDockObject_GetDockRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("DragDockObject_GetDockRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func DragDockObject_SetDockRect(obj uintptr, value TRect) {
	_, _, _ = getLazyProc("DragDockObject_SetDockRect").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func DragDockObject_GetEraseDockRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("DragDockObject_GetEraseDockRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func DragDockObject_SetEraseDockRect(obj uintptr, value TRect) {
	_, _, _ = getLazyProc("DragDockObject_SetEraseDockRect").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func DragDockObject_SetFloating(obj uintptr, value bool) {
	_, _, _ = getLazyProc("DragDockObject_SetFloating").Call(obj, GoBoolToDBool(value))
}
...
func DragDockObject_SetControl(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("DragDockObject_SetControl").Call(obj, value)
}
...
func DragDockObject_SetAlwaysShowDragImages(obj uintptr, value bool) {
	_, _, _ = getLazyProc("DragDockObject_SetAlwaysShowDragImages").Call(obj, GoBoolToDBool(value))
}

func DragDockObject_GetDragPos(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("DragDockObject_GetDragPos").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func DragDockObject_SetDragPos(obj uintptr, value TPoint) {
	_, _, _ = getLazyProc("DragDockObject_SetDragPos").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func DragDockObject_SetDragTarget(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("DragDockObject_SetDragTarget").Call(obj, value)
}

func DragDockObject_GetDragTargetPos(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("DragDockObject_GetDragTargetPos").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func DragDockObject_SetDragTargetPos(obj uintptr, value TPoint) {
	_, _, _ = getLazyProc("DragDockObject_SetDragTargetPos").Call(obj, uintptr(unsafe.Pointer(&value)))
}
