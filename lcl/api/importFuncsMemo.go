...
func Memo_Free(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Free").Call(obj)
}

func Memo_Append(obj uintptr, Value string) {
	_, _, _ = getLazyProc("Memo_Append").Call(obj, GoStrToDStr(Value))
}

func Memo_Clear(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Clear").Call(obj)
}

func Memo_ClearSelection(obj uintptr) {
	_, _, _ = getLazyProc("Memo_ClearSelection").Call(obj)
}

func Memo_CopyToClipboard(obj uintptr) {
	_, _, _ = getLazyProc("Memo_CopyToClipboard").Call(obj)
}

func Memo_CutToClipboard(obj uintptr) {
	_, _, _ = getLazyProc("Memo_CutToClipboard").Call(obj)
}

func Memo_PasteFromClipboard(obj uintptr) {
	_, _, _ = getLazyProc("Memo_PasteFromClipboard").Call(obj)
}

func Memo_Undo(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Undo").Call(obj)
}

func Memo_SelectAll(obj uintptr) {
	_, _, _ = getLazyProc("Memo_SelectAll").Call(obj)
}
...
func Memo_DisableAlign(obj uintptr) {
	_, _, _ = getLazyProc("Memo_DisableAlign").Call(obj)
}

func Memo_EnableAlign(obj uintptr) {
	_, _, _ = getLazyProc("Memo_EnableAlign").Call(obj)
}
...
func Memo_FlipChildren(obj uintptr, AllLevels bool) {
	_, _, _ = getLazyProc("Memo_FlipChildren").Call(obj, GoBoolToDBool(AllLevels))
}
...
func Memo_InsertControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("Memo_InsertControl").Call(obj, AControl)
}

func Memo_Invalidate(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Invalidate").Call(obj)
}

func Memo_PaintTo(obj uintptr, DC HDC, X int32, Y int32) {
	_, _, _ = getLazyProc("Memo_PaintTo").Call(obj, DC, uintptr(X), uintptr(Y))
}

func Memo_RemoveControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("Memo_RemoveControl").Call(obj, AControl)
}

func Memo_Realign(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Realign").Call(obj)
}

func Memo_Repaint(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Repaint").Call(obj)
}

func Memo_ScaleBy(obj uintptr, M int32, D int32) {
	_, _, _ = getLazyProc("Memo_ScaleBy").Call(obj, uintptr(M), uintptr(D))
}

func Memo_ScrollBy(obj uintptr, DeltaX int32, DeltaY int32) {
	_, _, _ = getLazyProc("Memo_ScrollBy").Call(obj, uintptr(DeltaX), uintptr(DeltaY))
}

func Memo_SetBounds(obj uintptr, ALeft int32, ATop int32, AWidth int32, AHeight int32) {
	_, _, _ = getLazyProc("Memo_SetBounds").Call(obj, uintptr(ALeft), uintptr(ATop), uintptr(AWidth), uintptr(AHeight))
}

func Memo_SetFocus(obj uintptr) {
	_, _, _ = getLazyProc("Memo_SetFocus").Call(obj)
}

func Memo_Update(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Update").Call(obj)
}

func Memo_BringToFront(obj uintptr) {
	_, _, _ = getLazyProc("Memo_BringToFront").Call(obj)
}

func Memo_ClientToScreen(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_ClientToScreen").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_ClientToParent(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_ClientToParent").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func Memo_Hide(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Hide").Call(obj)
}
...
func Memo_Refresh(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Refresh").Call(obj)
}

func Memo_ScreenToClient(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_ScreenToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_ParentToClient(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_ParentToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_SendToBack(obj uintptr) {
	_, _, _ = getLazyProc("Memo_SendToBack").Call(obj)
}

func Memo_Show(obj uintptr) {
	_, _, _ = getLazyProc("Memo_Show").Call(obj)
}
...
func Memo_SetTextBuf(obj uintptr, Buffer string) {
	_, _, _ = getLazyProc("Memo_SetTextBuf").Call(obj, GoStrToDStr(Buffer))
}
...
func Memo_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("Memo_Assign").Call(obj, Source)
}
...
func Memo_AnchorToNeighbour(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("Memo_AnchorToNeighbour").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func Memo_AnchorParallel(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("Memo_AnchorParallel").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func Memo_AnchorHorizontalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("Memo_AnchorHorizontalCenterTo").Call(obj, ASibling)
}

func Memo_AnchorVerticalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("Memo_AnchorVerticalCenterTo").Call(obj, ASibling)
}

func Memo_AnchorSame(obj uintptr, ASide TAnchorKind, ASibling uintptr) {
	_, _, _ = getLazyProc("Memo_AnchorSame").Call(obj, uintptr(ASide), ASibling)
}

func Memo_AnchorAsAlign(obj uintptr, ATheAlign TAlign, ASpace int32) {
	_, _, _ = getLazyProc("Memo_AnchorAsAlign").Call(obj, uintptr(ATheAlign), uintptr(ASpace))
}

func Memo_AnchorClient(obj uintptr, ASpace int32) {
	_, _, _ = getLazyProc("Memo_AnchorClient").Call(obj, uintptr(ASpace))
}
...
func Memo_AutoAdjustLayout(obj uintptr, AMode TLayoutAdjustmentPolicy, AFromPPI int32, AToPPI int32, AOldFormWidth int32, ANewFormWidth int32) {
	_, _, _ = getLazyProc("Memo_AutoAdjustLayout").Call(obj, uintptr(AMode), uintptr(AFromPPI), uintptr(AToPPI), uintptr(AOldFormWidth), uintptr(ANewFormWidth))
}

func Memo_FixDesignFontsPPI(obj uintptr, ADesignTimePPI int32) {
	_, _, _ = getLazyProc("Memo_FixDesignFontsPPI").Call(obj, uintptr(ADesignTimePPI))
}

func Memo_ScaleFontsPPI(obj uintptr, AToPPI int32, AProportion float64) {
	_, _, _ = getLazyProc("Memo_ScaleFontsPPI").Call(obj, uintptr(AToPPI), uintptr(unsafe.Pointer(&AProportion)))
}
...
func Memo_SetAlign(obj uintptr, value TAlign) {
	_, _, _ = getLazyProc("Memo_SetAlign").Call(obj, uintptr(value))
}
...
func Memo_SetAlignment(obj uintptr, value TAlignment) {
	_, _, _ = getLazyProc("Memo_SetAlignment").Call(obj, uintptr(value))
}
...
func Memo_SetAnchors(obj uintptr, value TAnchors) {
	_, _, _ = getLazyProc("Memo_SetAnchors").Call(obj, uintptr(value))
}
...
func Memo_SetBiDiMode(obj uintptr, value TBiDiMode) {
	_, _, _ = getLazyProc("Memo_SetBiDiMode").Call(obj, uintptr(value))
}
...
func Memo_SetBorderStyle(obj uintptr, value TBorderStyle) {
	_, _, _ = getLazyProc("Memo_SetBorderStyle").Call(obj, uintptr(value))
}
...
func Memo_SetCharCase(obj uintptr, value TEditCharCase) {
	_, _, _ = getLazyProc("Memo_SetCharCase").Call(obj, uintptr(value))
}
...
func Memo_SetColor(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("Memo_SetColor").Call(obj, uintptr(value))
}
...
func Memo_SetConstraints(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetConstraints").Call(obj, value)
}
...
func Memo_SetDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetDragCursor(obj uintptr, value TCursor) {
	_, _, _ = getLazyProc("Memo_SetDragCursor").Call(obj, uintptr(value))
}
...
func Memo_SetDragKind(obj uintptr, value TDragKind) {
	_, _, _ = getLazyProc("Memo_SetDragKind").Call(obj, uintptr(value))
}
...
func Memo_SetDragMode(obj uintptr, value TDragMode) {
	_, _, _ = getLazyProc("Memo_SetDragMode").Call(obj, uintptr(value))
}
...
func Memo_SetEnabled(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetEnabled").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetFont(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetFont").Call(obj, value)
}
...
func Memo_SetHideSelection(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetHideSelection").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetLines(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetLines").Call(obj, value)
}
...
func Memo_SetMaxLength(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetMaxLength").Call(obj, uintptr(value))
}
...
func Memo_SetParentColor(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetParentColor").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetParentDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetParentDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetParentFont(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetParentFont").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetParentShowHint(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetParentShowHint").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetPopupMenu(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetPopupMenu").Call(obj, value)
}
...
func Memo_SetReadOnly(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetReadOnly").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetScrollBars(obj uintptr, value TScrollStyle) {
	_, _, _ = getLazyProc("Memo_SetScrollBars").Call(obj, uintptr(value))
}
...
func Memo_SetShowHint(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetShowHint").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetTabOrder(obj uintptr, value TTabOrder) {
	_, _, _ = getLazyProc("Memo_SetTabOrder").Call(obj, uintptr(value))
}
...
func Memo_SetTabStop(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetTabStop").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetVisible(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetVisible").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetWantReturns(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetWantReturns").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetWantTabs(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetWantTabs").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetWordWrap(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetWordWrap").Call(obj, GoBoolToDBool(value))
}

func Memo_SetOnChange(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnChange").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnClick(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnClick").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnContextPopup(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnContextPopup").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnDblClick(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnDblClick").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnDragDrop(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnDragDrop").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnDragOver(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnDragOver").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnEndDrag(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnEndDrag").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnEnter(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnEnter").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnExit(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnExit").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnKeyDown(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnKeyDown").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnKeyPress(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnKeyPress").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnKeyUp(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnKeyUp").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnMouseDown(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnMouseDown").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnMouseEnter(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnMouseEnter").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnMouseLeave(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnMouseLeave").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnMouseMove(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnMouseMove").Call(obj, addEventToMap(obj, fn))
}

func Memo_SetOnMouseUp(obj uintptr, fn any) {
	_, _, _ = getLazyProc("Memo_SetOnMouseUp").Call(obj, addEventToMap(obj, fn))
}

func Memo_GetCaretPos(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_GetCaretPos").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_SetCaretPos(obj uintptr, value TPoint) {
	_, _, _ = getLazyProc("Memo_SetCaretPos").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func Memo_SetModified(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetModified").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetSelLength(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetSelLength").Call(obj, uintptr(value))
}
...
func Memo_SetSelStart(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetSelStart").Call(obj, uintptr(value))
}
...
func Memo_SetSelText(obj uintptr, value string) {
	_, _, _ = getLazyProc("Memo_SetSelText").Call(obj, GoStrToDStr(value))
}
...
func Memo_SetText(obj uintptr, value string) {
	_, _, _ = getLazyProc("Memo_SetText").Call(obj, GoStrToDStr(value))
}
...
func Memo_SetTextHint(obj uintptr, value string) {
	_, _, _ = getLazyProc("Memo_SetTextHint").Call(obj, GoStrToDStr(value))
}
...
func Memo_SetDockSite(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetDockSite").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetParentWindow(obj uintptr, value HWND) {
	_, _, _ = getLazyProc("Memo_SetParentWindow").Call(obj, value)
}
...
func Memo_SetUseDockManager(obj uintptr, value bool) {
	_, _, _ = getLazyProc("Memo_SetUseDockManager").Call(obj, GoBoolToDBool(value))
}
...
func Memo_SetAction(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetAction").Call(obj, value)
}

func Memo_GetBoundsRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("Memo_GetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_SetBoundsRect(obj uintptr, value TRect) {
	_, _, _ = getLazyProc("Memo_SetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func Memo_SetClientHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetClientHeight").Call(obj, uintptr(value))
}

func Memo_GetClientOrigin(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("Memo_GetClientOrigin").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func Memo_GetClientRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("Memo_GetClientRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func Memo_SetClientWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetClientWidth").Call(obj, uintptr(value))
}
...
func Memo_SetControlState(obj uintptr, value TControlState) {
	_, _, _ = getLazyProc("Memo_SetControlState").Call(obj, uintptr(value))
}
...
func Memo_SetControlStyle(obj uintptr, value TControlStyle) {
	_, _, _ = getLazyProc("Memo_SetControlStyle").Call(obj, uintptr(value))
}
...
func Memo_SetParent(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetParent").Call(obj, value)
}
...
func Memo_SetLeft(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetLeft").Call(obj, uintptr(value))
}
...
func Memo_SetTop(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetTop").Call(obj, uintptr(value))
}
...
func Memo_SetWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetWidth").Call(obj, uintptr(value))
}
...
func Memo_SetHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetHeight").Call(obj, uintptr(value))
}
...
func Memo_SetCursor(obj uintptr, value TCursor) {
	_, _, _ = getLazyProc("Memo_SetCursor").Call(obj, uintptr(value))
}
...
func Memo_SetHint(obj uintptr, value string) {
	_, _, _ = getLazyProc("Memo_SetHint").Call(obj, GoStrToDStr(value))
}
...
func Memo_SetComponentIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("Memo_SetComponentIndex").Call(obj, uintptr(value))
}
...
func Memo_SetName(obj uintptr, value string) {
	_, _, _ = getLazyProc("Memo_SetName").Call(obj, GoStrToDStr(value))
}
...
func Memo_SetTag(obj uintptr, value int) {
	_, _, _ = getLazyProc("Memo_SetTag").Call(obj, uintptr(value))
}
...
func Memo_SetAnchorSideLeft(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetAnchorSideLeft").Call(obj, value)
}
...
func Memo_SetAnchorSideTop(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetAnchorSideTop").Call(obj, value)
}
...
func Memo_SetAnchorSideRight(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetAnchorSideRight").Call(obj, value)
}
...
func Memo_SetAnchorSideBottom(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetAnchorSideBottom").Call(obj, value)
}
...
func Memo_SetChildSizing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetChildSizing").Call(obj, value)
}
...
func Memo_SetBorderSpacing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("Memo_SetBorderSpacing").Call(obj, value)
}
