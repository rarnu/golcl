...
func MainMenu_Free(obj uintptr) {
	_, _, _ = getLazyProc("MainMenu_Free").Call(obj)
}
...
func MainMenu_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("MainMenu_Assign").Call(obj, Source)
}
...
func MainMenu_SetImagesWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("MainMenu_SetImagesWidth").Call(obj, uintptr(value))
}
...
func MainMenu_SetBiDiMode(obj uintptr, value TBiDiMode) {
	_, _, _ = getLazyProc("MainMenu_SetBiDiMode").Call(obj, uintptr(value))
}
...
func MainMenu_SetImages(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("MainMenu_SetImages").Call(obj, value)
}
...
func MainMenu_SetOwnerDraw(obj uintptr, value bool) {
	_, _, _ = getLazyProc("MainMenu_SetOwnerDraw").Call(obj, GoBoolToDBool(value))
}

func MainMenu_SetOnChange(obj uintptr, fn any) {
	_, _, _ = getLazyProc("MainMenu_SetOnChange").Call(obj, addEventToMap(obj, fn))
}
...
func MainMenu_SetComponentIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("MainMenu_SetComponentIndex").Call(obj, uintptr(value))
}
...
func MainMenu_SetName(obj uintptr, value string) {
	_, _, _ = getLazyProc("MainMenu_SetName").Call(obj, GoStrToDStr(value))
}
...
func MainMenu_SetTag(obj uintptr, value int) {
	_, _, _ = getLazyProc("MainMenu_SetTag").Call(obj, uintptr(value))
}
