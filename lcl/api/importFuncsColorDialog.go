...
func ColorDialog_Free(obj uintptr) {
	_, _, _ = getLazyProc("ColorDialog_Free").Call(obj)
}
...
func ColorDialog_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("ColorDialog_Assign").Call(obj, Source)
}
...
func ColorDialog_SetColor(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("ColorDialog_SetColor").Call(obj, uintptr(value))
}
...
func ColorDialog_SetCustomColors(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorDialog_SetCustomColors").Call(obj, value)
}
...
func ColorDialog_SetOnClose(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorDialog_SetOnClose").Call(obj, addEventToMap(obj, fn))
}

func ColorDialog_SetOnShow(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorDialog_SetOnShow").Call(obj, addEventToMap(obj, fn))
}
...
func ColorDialog_SetComponentIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorDialog_SetComponentIndex").Call(obj, uintptr(value))
}
...
func ColorDialog_SetName(obj uintptr, value string) {
	_, _, _ = getLazyProc("ColorDialog_SetName").Call(obj, GoStrToDStr(value))
}
...
func ColorDialog_SetTag(obj uintptr, value int) {
	_, _, _ = getLazyProc("ColorDialog_SetTag").Call(obj, uintptr(value))
}
