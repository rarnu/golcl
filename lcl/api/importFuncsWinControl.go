...
func WinControl_Free(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Free").Call(obj)
}
...
func WinControl_DisableAlign(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_DisableAlign").Call(obj)
}

func WinControl_EnableAlign(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_EnableAlign").Call(obj)
}
...
func WinControl_FlipChildren(obj uintptr, AllLevels bool) {
	_, _, _ = getLazyProc("WinControl_FlipChildren").Call(obj, GoBoolToDBool(AllLevels))
}
...
func WinControl_InsertControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("WinControl_InsertControl").Call(obj, AControl)
}

func WinControl_Invalidate(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Invalidate").Call(obj)
}

func WinControl_PaintTo(obj uintptr, DC HDC, X int32, Y int32) {
	_, _, _ = getLazyProc("WinControl_PaintTo").Call(obj, DC, uintptr(X), uintptr(Y))
}

func WinControl_RemoveControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("WinControl_RemoveControl").Call(obj, AControl)
}

func WinControl_Realign(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Realign").Call(obj)
}

func WinControl_Repaint(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Repaint").Call(obj)
}

func WinControl_ScaleBy(obj uintptr, M int32, D int32) {
	_, _, _ = getLazyProc("WinControl_ScaleBy").Call(obj, uintptr(M), uintptr(D))
}

func WinControl_ScrollBy(obj uintptr, DeltaX int32, DeltaY int32) {
	_, _, _ = getLazyProc("WinControl_ScrollBy").Call(obj, uintptr(DeltaX), uintptr(DeltaY))
}

func WinControl_SetBounds(obj uintptr, ALeft int32, ATop int32, AWidth int32, AHeight int32) {
	_, _, _ = getLazyProc("WinControl_SetBounds").Call(obj, uintptr(ALeft), uintptr(ATop), uintptr(AWidth), uintptr(AHeight))
}

func WinControl_SetFocus(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_SetFocus").Call(obj)
}

func WinControl_Update(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Update").Call(obj)
}

func WinControl_BringToFront(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_BringToFront").Call(obj)
}

func WinControl_ClientToScreen(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("WinControl_ClientToScreen").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func WinControl_ClientToParent(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("WinControl_ClientToParent").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func WinControl_Hide(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Hide").Call(obj)
}
...
func WinControl_Refresh(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Refresh").Call(obj)
}

func WinControl_ScreenToClient(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("WinControl_ScreenToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func WinControl_ParentToClient(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("WinControl_ParentToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func WinControl_SendToBack(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_SendToBack").Call(obj)
}

func WinControl_Show(obj uintptr) {
	_, _, _ = getLazyProc("WinControl_Show").Call(obj)
}
...
func WinControl_SetTextBuf(obj uintptr, Buffer string) {
	_, _, _ = getLazyProc("WinControl_SetTextBuf").Call(obj, GoStrToDStr(Buffer))
}
...
func WinControl_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("WinControl_Assign").Call(obj, Source)
}
...
func WinControl_AnchorToNeighbour(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("WinControl_AnchorToNeighbour").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func WinControl_AnchorParallel(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("WinControl_AnchorParallel").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func WinControl_AnchorHorizontalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("WinControl_AnchorHorizontalCenterTo").Call(obj, ASibling)
}

func WinControl_AnchorVerticalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("WinControl_AnchorVerticalCenterTo").Call(obj, ASibling)
}

func WinControl_AnchorSame(obj uintptr, ASide TAnchorKind, ASibling uintptr) {
	_, _, _ = getLazyProc("WinControl_AnchorSame").Call(obj, uintptr(ASide), ASibling)
}

func WinControl_AnchorAsAlign(obj uintptr, ATheAlign TAlign, ASpace int32) {
	_, _, _ = getLazyProc("WinControl_AnchorAsAlign").Call(obj, uintptr(ATheAlign), uintptr(ASpace))
}

func WinControl_AnchorClient(obj uintptr, ASpace int32) {
	_, _, _ = getLazyProc("WinControl_AnchorClient").Call(obj, uintptr(ASpace))
}
...
func WinControl_AutoAdjustLayout(obj uintptr, AMode TLayoutAdjustmentPolicy, AFromPPI int32, AToPPI int32, AOldFormWidth int32, ANewFormWidth int32) {
	_, _, _ = getLazyProc("WinControl_AutoAdjustLayout").Call(obj, uintptr(AMode), uintptr(AFromPPI), uintptr(AToPPI), uintptr(AOldFormWidth), uintptr(ANewFormWidth))
}

func WinControl_FixDesignFontsPPI(obj uintptr, ADesignTimePPI int32) {
	_, _, _ = getLazyProc("WinControl_FixDesignFontsPPI").Call(obj, uintptr(ADesignTimePPI))
}

func WinControl_ScaleFontsPPI(obj uintptr, AToPPI int32, AProportion float64) {
	_, _, _ = getLazyProc("WinControl_ScaleFontsPPI").Call(obj, uintptr(AToPPI), uintptr(unsafe.Pointer(&AProportion)))
}
...
func WinControl_SetDockSite(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetDockSite").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetParentDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetParentDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetParentWindow(obj uintptr, value HWND) {
	_, _, _ = getLazyProc("WinControl_SetParentWindow").Call(obj, value)
}
...
func WinControl_SetTabOrder(obj uintptr, value TTabOrder) {
	_, _, _ = getLazyProc("WinControl_SetTabOrder").Call(obj, uintptr(value))
}
...
func WinControl_SetTabStop(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetTabStop").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetUseDockManager(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetUseDockManager").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetEnabled(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetEnabled").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetAction(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetAction").Call(obj, value)
}
...
func WinControl_SetAlign(obj uintptr, value TAlign) {
	_, _, _ = getLazyProc("WinControl_SetAlign").Call(obj, uintptr(value))
}
...
func WinControl_SetAnchors(obj uintptr, value TAnchors) {
	_, _, _ = getLazyProc("WinControl_SetAnchors").Call(obj, uintptr(value))
}
...
func WinControl_SetBiDiMode(obj uintptr, value TBiDiMode) {
	_, _, _ = getLazyProc("WinControl_SetBiDiMode").Call(obj, uintptr(value))
}

func WinControl_GetBoundsRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("WinControl_GetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func WinControl_SetBoundsRect(obj uintptr, value TRect) {
	_, _, _ = getLazyProc("WinControl_SetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func WinControl_SetClientHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetClientHeight").Call(obj, uintptr(value))
}

func WinControl_GetClientOrigin(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("WinControl_GetClientOrigin").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func WinControl_GetClientRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("WinControl_GetClientRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func WinControl_SetClientWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetClientWidth").Call(obj, uintptr(value))
}
...
func WinControl_SetConstraints(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetConstraints").Call(obj, value)
}
...
func WinControl_SetControlState(obj uintptr, value TControlState) {
	_, _, _ = getLazyProc("WinControl_SetControlState").Call(obj, uintptr(value))
}
...
func WinControl_SetControlStyle(obj uintptr, value TControlStyle) {
	_, _, _ = getLazyProc("WinControl_SetControlStyle").Call(obj, uintptr(value))
}
...
func WinControl_SetShowHint(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetShowHint").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetVisible(obj uintptr, value bool) {
	_, _, _ = getLazyProc("WinControl_SetVisible").Call(obj, GoBoolToDBool(value))
}
...
func WinControl_SetParent(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetParent").Call(obj, value)
}
...
func WinControl_SetLeft(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetLeft").Call(obj, uintptr(value))
}
...
func WinControl_SetTop(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetTop").Call(obj, uintptr(value))
}
...
func WinControl_SetWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetWidth").Call(obj, uintptr(value))
}
...
func WinControl_SetHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetHeight").Call(obj, uintptr(value))
}
...
func WinControl_SetCursor(obj uintptr, value TCursor) {
	_, _, _ = getLazyProc("WinControl_SetCursor").Call(obj, uintptr(value))
}
...
func WinControl_SetHint(obj uintptr, value string) {
	_, _, _ = getLazyProc("WinControl_SetHint").Call(obj, GoStrToDStr(value))
}
...
func WinControl_SetComponentIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("WinControl_SetComponentIndex").Call(obj, uintptr(value))
}
...
func WinControl_SetName(obj uintptr, value string) {
	_, _, _ = getLazyProc("WinControl_SetName").Call(obj, GoStrToDStr(value))
}
...
func WinControl_SetTag(obj uintptr, value int) {
	_, _, _ = getLazyProc("WinControl_SetTag").Call(obj, uintptr(value))
}
...
func WinControl_SetAnchorSideLeft(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetAnchorSideLeft").Call(obj, value)
}
...
func WinControl_SetAnchorSideTop(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetAnchorSideTop").Call(obj, value)
}
...
func WinControl_SetAnchorSideRight(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetAnchorSideRight").Call(obj, value)
}
...
func WinControl_SetAnchorSideBottom(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetAnchorSideBottom").Call(obj, value)
}
...
func WinControl_SetChildSizing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetChildSizing").Call(obj, value)
}
...
func WinControl_SetBorderSpacing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("WinControl_SetBorderSpacing").Call(obj, value)
}
