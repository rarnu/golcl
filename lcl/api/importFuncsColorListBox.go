...
func ColorListBox_Free(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Free").Call(obj)
}

func ColorListBox_AddItem(obj uintptr, Item string, AObject uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AddItem").Call(obj, GoStrToDStr(Item), AObject)
}

func ColorListBox_Clear(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Clear").Call(obj)
}

func ColorListBox_ClearSelection(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_ClearSelection").Call(obj)
}

func ColorListBox_DeleteSelected(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_DeleteSelected").Call(obj)
}
...
func ColorListBox_ItemRect(obj uintptr, Index int32) TRect {
	var ret TRect
	_, _, _ = getLazyProc("ColorListBox_ItemRect").Call(obj, uintptr(Index), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_SelectAll(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SelectAll").Call(obj)
}
...
func ColorListBox_DisableAlign(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_DisableAlign").Call(obj)
}

func ColorListBox_EnableAlign(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_EnableAlign").Call(obj)
}
...
func ColorListBox_FlipChildren(obj uintptr, AllLevels bool) {
	_, _, _ = getLazyProc("ColorListBox_FlipChildren").Call(obj, GoBoolToDBool(AllLevels))
}
...
func ColorListBox_InsertControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("ColorListBox_InsertControl").Call(obj, AControl)
}

func ColorListBox_Invalidate(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Invalidate").Call(obj)
}

func ColorListBox_PaintTo(obj uintptr, DC HDC, X int32, Y int32) {
	_, _, _ = getLazyProc("ColorListBox_PaintTo").Call(obj, DC, uintptr(X), uintptr(Y))
}

func ColorListBox_RemoveControl(obj uintptr, AControl uintptr) {
	_, _, _ = getLazyProc("ColorListBox_RemoveControl").Call(obj, AControl)
}

func ColorListBox_Realign(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Realign").Call(obj)
}

func ColorListBox_Repaint(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Repaint").Call(obj)
}

func ColorListBox_ScaleBy(obj uintptr, M int32, D int32) {
	_, _, _ = getLazyProc("ColorListBox_ScaleBy").Call(obj, uintptr(M), uintptr(D))
}

func ColorListBox_ScrollBy(obj uintptr, DeltaX int32, DeltaY int32) {
	_, _, _ = getLazyProc("ColorListBox_ScrollBy").Call(obj, uintptr(DeltaX), uintptr(DeltaY))
}

func ColorListBox_SetBounds(obj uintptr, ALeft int32, ATop int32, AWidth int32, AHeight int32) {
	_, _, _ = getLazyProc("ColorListBox_SetBounds").Call(obj, uintptr(ALeft), uintptr(ATop), uintptr(AWidth), uintptr(AHeight))
}

func ColorListBox_SetFocus(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetFocus").Call(obj)
}

func ColorListBox_Update(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Update").Call(obj)
}

func ColorListBox_BringToFront(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_BringToFront").Call(obj)
}

func ColorListBox_ClientToScreen(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ColorListBox_ClientToScreen").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_ClientToParent(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ColorListBox_ClientToParent").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func ColorListBox_Hide(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Hide").Call(obj)
}
...
func ColorListBox_Refresh(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Refresh").Call(obj)
}

func ColorListBox_ScreenToClient(obj uintptr, Point TPoint) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ColorListBox_ScreenToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_ParentToClient(obj uintptr, Point TPoint, AParent uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ColorListBox_ParentToClient").Call(obj, uintptr(unsafe.Pointer(&Point)), AParent, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_SendToBack(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SendToBack").Call(obj)
}

func ColorListBox_Show(obj uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Show").Call(obj)
}
...
func ColorListBox_SetTextBuf(obj uintptr, Buffer string) {
	_, _, _ = getLazyProc("ColorListBox_SetTextBuf").Call(obj, GoStrToDStr(Buffer))
}
...
func ColorListBox_Assign(obj uintptr, Source uintptr) {
	_, _, _ = getLazyProc("ColorListBox_Assign").Call(obj, Source)
}
...
func ColorListBox_AnchorToNeighbour(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AnchorToNeighbour").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func ColorListBox_AnchorParallel(obj uintptr, ASide TAnchorKind, ASpace int32, ASibling uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AnchorParallel").Call(obj, uintptr(ASide), uintptr(ASpace), ASibling)
}

func ColorListBox_AnchorHorizontalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AnchorHorizontalCenterTo").Call(obj, ASibling)
}

func ColorListBox_AnchorVerticalCenterTo(obj uintptr, ASibling uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AnchorVerticalCenterTo").Call(obj, ASibling)
}

func ColorListBox_AnchorSame(obj uintptr, ASide TAnchorKind, ASibling uintptr) {
	_, _, _ = getLazyProc("ColorListBox_AnchorSame").Call(obj, uintptr(ASide), ASibling)
}

func ColorListBox_AnchorAsAlign(obj uintptr, ATheAlign TAlign, ASpace int32) {
	_, _, _ = getLazyProc("ColorListBox_AnchorAsAlign").Call(obj, uintptr(ATheAlign), uintptr(ASpace))
}

func ColorListBox_AnchorClient(obj uintptr, ASpace int32) {
	_, _, _ = getLazyProc("ColorListBox_AnchorClient").Call(obj, uintptr(ASpace))
}
...
func ColorListBox_AutoAdjustLayout(obj uintptr, AMode TLayoutAdjustmentPolicy, AFromPPI int32, AToPPI int32, AOldFormWidth int32, ANewFormWidth int32) {
	_, _, _ = getLazyProc("ColorListBox_AutoAdjustLayout").Call(obj, uintptr(AMode), uintptr(AFromPPI), uintptr(AToPPI), uintptr(AOldFormWidth), uintptr(ANewFormWidth))
}

func ColorListBox_FixDesignFontsPPI(obj uintptr, ADesignTimePPI int32) {
	_, _, _ = getLazyProc("ColorListBox_FixDesignFontsPPI").Call(obj, uintptr(ADesignTimePPI))
}

func ColorListBox_ScaleFontsPPI(obj uintptr, AToPPI int32, AProportion float64) {
	_, _, _ = getLazyProc("ColorListBox_ScaleFontsPPI").Call(obj, uintptr(AToPPI), uintptr(unsafe.Pointer(&AProportion)))
}
...
func ColorListBox_SetAlign(obj uintptr, value TAlign) {
	_, _, _ = getLazyProc("ColorListBox_SetAlign").Call(obj, uintptr(value))
}
...
func ColorListBox_SetDefaultColorColor(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("ColorListBox_SetDefaultColorColor").Call(obj, uintptr(value))
}
...
func ColorListBox_SetNoneColorColor(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("ColorListBox_SetNoneColorColor").Call(obj, uintptr(value))
}
...
func ColorListBox_SetSelected(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("ColorListBox_SetSelected").Call(obj, uintptr(value))
}
...
func ColorListBox_SetStyle(obj uintptr, value TColorBoxStyle) {
	_, _, _ = getLazyProc("ColorListBox_SetStyle").Call(obj, uintptr(value))
}
...
func ColorListBox_SetAnchors(obj uintptr, value TAnchors) {
	_, _, _ = getLazyProc("ColorListBox_SetAnchors").Call(obj, uintptr(value))
}
...
func ColorListBox_SetBiDiMode(obj uintptr, value TBiDiMode) {
	_, _, _ = getLazyProc("ColorListBox_SetBiDiMode").Call(obj, uintptr(value))
}
...
func ColorListBox_SetColor(obj uintptr, value TColor) {
	_, _, _ = getLazyProc("ColorListBox_SetColor").Call(obj, uintptr(value))
}
...
func ColorListBox_SetConstraints(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetConstraints").Call(obj, value)
}
...
func ColorListBox_SetDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetEnabled(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetEnabled").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetFont(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetFont").Call(obj, value)
}
...
func ColorListBox_SetItemHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetItemHeight").Call(obj, uintptr(value))
}
...
func ColorListBox_SetParentColor(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetParentColor").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetParentDoubleBuffered(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetParentDoubleBuffered").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetParentFont(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetParentFont").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetParentShowHint(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetParentShowHint").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetPopupMenu(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetPopupMenu").Call(obj, value)
}
...
func ColorListBox_SetShowHint(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetShowHint").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetTabOrder(obj uintptr, value TTabOrder) {
	_, _, _ = getLazyProc("ColorListBox_SetTabOrder").Call(obj, uintptr(value))
}
...
func ColorListBox_SetTabStop(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetTabStop").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetVisible(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetVisible").Call(obj, GoBoolToDBool(value))
}

func ColorListBox_SetOnClick(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnClick").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnContextPopup(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnContextPopup").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnDblClick(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnDblClick").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnDragDrop(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnDragDrop").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnDragOver(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnDragOver").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnEndDrag(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnEndDrag").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnEnter(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnEnter").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnExit(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnExit").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnKeyDown(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnKeyDown").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnKeyPress(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnKeyPress").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnKeyUp(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnKeyUp").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnMouseDown(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnMouseDown").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnMouseEnter(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnMouseEnter").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnMouseLeave(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnMouseLeave").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnMouseMove(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnMouseMove").Call(obj, addEventToMap(obj, fn))
}

func ColorListBox_SetOnMouseUp(obj uintptr, fn any) {
	_, _, _ = getLazyProc("ColorListBox_SetOnMouseUp").Call(obj, addEventToMap(obj, fn))
}
...
func ColorListBox_SetItems(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetItems").Call(obj, value)
}
...
func ColorListBox_SetTopIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetTopIndex").Call(obj, uintptr(value))
}
...
func ColorListBox_SetMultiSelect(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetMultiSelect").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetItemIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetItemIndex").Call(obj, uintptr(value))
}
...
func ColorListBox_SetDockSite(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetDockSite").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetParentWindow(obj uintptr, value HWND) {
	_, _, _ = getLazyProc("ColorListBox_SetParentWindow").Call(obj, value)
}
...
func ColorListBox_SetUseDockManager(obj uintptr, value bool) {
	_, _, _ = getLazyProc("ColorListBox_SetUseDockManager").Call(obj, GoBoolToDBool(value))
}
...
func ColorListBox_SetAction(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetAction").Call(obj, value)
}

func ColorListBox_GetBoundsRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("ColorListBox_GetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_SetBoundsRect(obj uintptr, value TRect) {
	_, _, _ = getLazyProc("ColorListBox_SetBoundsRect").Call(obj, uintptr(unsafe.Pointer(&value)))
}
...
func ColorListBox_SetClientHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetClientHeight").Call(obj, uintptr(value))
}

func ColorListBox_GetClientOrigin(obj uintptr) TPoint {
	var ret TPoint
	_, _, _ = getLazyProc("ColorListBox_GetClientOrigin").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}

func ColorListBox_GetClientRect(obj uintptr) TRect {
	var ret TRect
	_, _, _ = getLazyProc("ColorListBox_GetClientRect").Call(obj, uintptr(unsafe.Pointer(&ret)))
	return ret
}
...
func ColorListBox_SetClientWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetClientWidth").Call(obj, uintptr(value))
}
...
func ColorListBox_SetControlState(obj uintptr, value TControlState) {
	_, _, _ = getLazyProc("ColorListBox_SetControlState").Call(obj, uintptr(value))
}
...
func ColorListBox_SetControlStyle(obj uintptr, value TControlStyle) {
	_, _, _ = getLazyProc("ColorListBox_SetControlStyle").Call(obj, uintptr(value))
}
...
func ColorListBox_SetParent(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetParent").Call(obj, value)
}
...
func ColorListBox_SetLeft(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetLeft").Call(obj, uintptr(value))
}
...
func ColorListBox_SetTop(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetTop").Call(obj, uintptr(value))
}
...
func ColorListBox_SetWidth(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetWidth").Call(obj, uintptr(value))
}
...
func ColorListBox_SetHeight(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetHeight").Call(obj, uintptr(value))
}
...
func ColorListBox_SetCursor(obj uintptr, value TCursor) {
	_, _, _ = getLazyProc("ColorListBox_SetCursor").Call(obj, uintptr(value))
}
...
func ColorListBox_SetHint(obj uintptr, value string) {
	_, _, _ = getLazyProc("ColorListBox_SetHint").Call(obj, GoStrToDStr(value))
}
...
func ColorListBox_SetComponentIndex(obj uintptr, value int32) {
	_, _, _ = getLazyProc("ColorListBox_SetComponentIndex").Call(obj, uintptr(value))
}
...
func ColorListBox_SetName(obj uintptr, value string) {
	_, _, _ = getLazyProc("ColorListBox_SetName").Call(obj, GoStrToDStr(value))
}
...
func ColorListBox_SetTag(obj uintptr, value int) {
	_, _, _ = getLazyProc("ColorListBox_SetTag").Call(obj, uintptr(value))
}
...
func ColorListBox_SetAnchorSideLeft(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetAnchorSideLeft").Call(obj, value)
}
...
func ColorListBox_SetAnchorSideTop(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetAnchorSideTop").Call(obj, value)
}
...
func ColorListBox_SetAnchorSideRight(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetAnchorSideRight").Call(obj, value)
}
...
func ColorListBox_SetAnchorSideBottom(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetAnchorSideBottom").Call(obj, value)
}
...
func ColorListBox_SetChildSizing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetChildSizing").Call(obj, value)
}
...
func ColorListBox_SetBorderSpacing(obj uintptr, value uintptr) {
	_, _, _ = getLazyProc("ColorListBox_SetBorderSpacing").Call(obj, value)
}
